...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param  string  $name
     * @param  \QuantaForge\Log\Logger  $logger
     * @return \QuantaForge\Log\Logger
     */
    ...
    protected function createEmergencyLogger()
    {
        ...
        $handler = new StreamHandler(
            $config['path'] ?? $this->app->storagePath().'/logs/quantaforge.log',
            $this->level(['level' => 'debug'])
        );

        return new Logger(
            new Monolog('quantaforge', $this->prepareHandlers([$handler])),
            $this->app['events']
        );
    }
